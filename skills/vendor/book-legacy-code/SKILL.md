...
description: Working Effectively with Legacy Code techniques (characterization tests, breaking dependencies, seams) to consult when changing untested legacy code. Reference material, not a review. Use when the user asks how to safely modify legacy code or add tests around it.
---

<!-- Vendored verbatim from ciembor/agent-rules-books (MIT License).
     Source: https://github.com/ciembor/agent-rules-books/blob/main/working-effectively-with-legacy-code/working-effectively-with-legacy-code.mini.md
