...
description: Clean Architecture principles (dependency rule, boundaries, keeping business rules independent of frameworks and databases) to consult when designing or structuring code. Reference material, not a review. Use when the user asks about dependency direction, layering, or ports and adapters.
---

<!-- Vendored verbatim from ciembor/agent-rules-books (MIT License).
     Source: https://github.com/ciembor/agent-rules-books/blob/main/clean-architecture/clean-architecture.mini.md
