---
name: book-philosophy-of-software-design
description: Principles from A Philosophy of Software Design (deep modules, information hiding, reducing complexity and dependencies) to consult when designing a module or interface. Reference material, not a review. Use when the user asks about module depth, hiding complexity, or cutting dependencies.
---

<!-- Vendored verbatim from ciembor/agent-rules-books (MIT License).
     Source: https://github.com/ciembor/agent-rules-books/blob/main/a-philosophy-of-software-design/a-philosophy-of-software-design.mini.md
     Third-party reference. Exempt from repo diction and prettier. -->
