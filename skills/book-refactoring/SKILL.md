...
description: Refactoring techniques (behavior-preserving structural change, code smells) to consult when refactoring code. Reference material, not a review. Use when the user asks how to refactor safely, extract functions, or address a code smell.
---

<!-- Vendored verbatim from ciembor/agent-rules-books (MIT License).
     Source: https://github.com/ciembor/agent-rules-books/blob/main/refactoring/refactoring.mini.md
